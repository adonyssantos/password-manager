      ...
      <Dialog open={open} onClose={handleDisagree} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            This is an educative project. The data saved in this app can not be persistent in the database and there is no way to recover
            it. Also there is a limit of daily requests to the Database.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
